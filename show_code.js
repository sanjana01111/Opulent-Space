...
window.addEventListener('load' , () => {
    ...
    if (topic == 'living-room'){
        ...
        const namelist = ["Brown and white living room decor","Grey and white living room","Grey living room set","Purple, white and black living room set","Turquoise and brown living room set","Teal and grey living room set","White and blue living room set","White and silver themed decor","White living room with black and blue decor","White, grey and brown living room set"];
        const prilist = ["243,965","333,965","423,965","745,965","667,967","465,655","675,365","784,525","521,978"];
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `source/living room${i}.jpg`;
        ...
        const prilist = ["", "395,792", "393,808", "548,543", "418,989", "746,529", "877,211", "747,727", "687,048", "634,685", "902,661","835,863"];
        for (let i = 1; i < 11; i++) {
        ...
        for (let i = 1; i < 11; i++) {
            document.getElementById(`ima${i}`).src = `images/masterbedroom${i}.jpg`;
            document.getElementById(`hed${i}`).textContent = `${namelist[i]}`; 
            document.getElementById(`pri${i}`).textContent = `₹${prilist[i]}`;
        }
    }
